...
<form action="<?= $form->url ?>" id="<?= $form->formID() ?>">
    <?= $form->introduction ?>
    <div id="<?= $form->divDropzoneID() ?>" class="uoj dropzone"></div>
    <div id="<?= $form->helpBlockID() ?>">
        <span class="help-block"></span>
    </div>
    <div class="text-center top-buffer-md">
        <?= HTML::tag('button', [
...
<div class="hidden" id="<?= $form->formID() ?>-template">
    <div class="dz-preview dz-file-preview">
        <div class="dz-image"><img data-dz-thumbnail /></div>
        <div class="dz-details">
            <div class="dz-size"><span data-dz-size></span></div>
            <div class="dz-filename"><span data-dz-name></span></div>
            <a class="text-danger dz-remove" href="javascript:undefined;" data-dz-remove>移除</a>
        </div>
...
$(function() {
    ...
    $('form#<?= $form->formID() ?>').submit(function(e) {
        e.preventDefault();
        if ((<?= $form->submit_condition ?>)(myDropzone)) { myDropzone.processQueue(); }
    });
});
</script>
